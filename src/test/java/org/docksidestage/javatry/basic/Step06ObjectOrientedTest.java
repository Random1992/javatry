...
public class Step06ObjectOrientedTest extends PlainTestCase {
    ...
    public void test_objectOriented_aboutObject_usingObject() {
        ...
        // #dofixme you if step05 has been finished, you can use this code by jflute (2019/06/15)
        // _/_/_/_/_/_/_/_/_/_/
    ...
    private void doShowTicketBooth(TicketBooth booth) {
        log("Ticket Booth: quantity={}, salesProceeds={}", booth.getQuantity_ONE(), booth.getSalesProceeds());
    }
